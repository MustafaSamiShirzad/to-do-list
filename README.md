...
**[to-do-list]** is used to  display a to do list 
...
```
  cd my-folder
  git clone https://github.com/MustafaSamiShirzad/to-do-list
```
---
...
If you like this project plese support it through my email Mustafasami209@gmail.com
